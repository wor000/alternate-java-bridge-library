...
public class SlideDrawer extends ViewGroup {
	...
	public SlideDrawer( Context context, AttributeSet attrs, int defStyle )
	{
		...
		int orientation = a.getInt( com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_direction, ORIENTATION_BTT );
		mVertical = ( orientation == ORIENTATION_BTT || orientation == ORIENTATION_TTB );
		mBottomOffset = (int)a.getDimension( com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_bottomOffset, 0.0f );
		mTopOffset = (int)a.getDimension( com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_topOffset, 0.0f );
		mAllowSingleTap = a.getBoolean( com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_allowSingleTap, true );
		mAnimateOnClick = a.getBoolean( com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_animateOnClick, true );
		mInvert = ( orientation == ORIENTATION_TTB || orientation == ORIENTATION_LTR );
		
		int handleId = a.getResourceId( com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_handle, 0 );
		if ( handleId == 0 ) { throw new IllegalArgumentException( "The handle attribute is required and must refer "
				+ "to a valid child." ); }
		
		int contentId = a.getResourceId( com.xiledsystems.AlternateJavaBridgelib.R.styleable.DrawerSlider_content, 0 );
