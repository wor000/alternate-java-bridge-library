...
public final class LinearLayout implements Layout {
  ...
  public void add(SlideDrawer component) {
	  FrameLayout newframe = new FrameLayout(component.getView().getContext());
	  FrameLayout.LayoutParams lp1 = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT,
			  FrameLayout.LayoutParams.WRAP_CONTENT);
	  layoutManager.addView(newframe, lp1);
	  ViewGroup.LayoutParams lp2 = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, 
			  ViewGroup.LayoutParams.WRAP_CONTENT);
	  newframe.addView(component.getView(), lp2);
  }
